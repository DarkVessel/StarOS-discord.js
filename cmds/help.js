...
~~А когда набираете достаточный уровень, вы получаете звание-роль.~~ (Устарело, звания теперь можно купить только в магазине)
...
После получения уровня вы получите оповещение в канал <#${ChannelLevelID}>, оповещение будет на том языке, на котором у вас стоит роль.`;
          ...
          if (page == 14) {
            let a = `Звания.
Для их покупки нужен определённый уровень и определённое количество монет.
Званий всего 10.
<@&${RoleLevel5ID}> - За 5 уровень и 3000 OScoins.
<@&${RoleLevel10ID}> - За 10 уровень и 5000 OScoins.
<@&${RoleLevel15ID}> - За 15 уровень и 10000 OScoins.
<@&${RoleLevel20ID}> - За 20 уровень и 13000 OScoins.
<@&${RoleLevel25ID}> - За 25 уровень и 17000 OScoins.
<@&${RoleLevel30ID}> - За 30 уровень и 20000 OScoins.
<@&${RoleLevel35ID}> - За 35 уровень и 24000 OScoins.
<@&${RoleLevel40ID}> - За 40 уровень и 26000 OScoins.
<@&${RoleLevel50ID}> - За 50 уровень и 35000 OScoins.
<@&${RoleLevel65ID}> - За 65 уровень и 40000 OScoins.`;
            embed.setDescription(a);
            embed.setFooter(`Страница ${page} из ${Страниц}`);
            msg.edit(embed).then(msg => {
              msg.react("⏪");
