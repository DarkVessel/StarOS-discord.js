        ...
        if (!message.member.hasPermission("MANAGE_MESSAGES" || "MANAGE_ROLES")) {
            message.channel.send(
                new Discord.RichEmbed()
                    .setColor('RED')
                    .setDescription('🚫 | **У вас должны быть права на удаление сообщений или выдачи ролей!**')
                    .setTimestamp()
        ...
        if (!Time) {
            ...
            if (!reason1) {
                ...
                message.channel.send(
                    new RichEmbed()
                        .setColor(colors)
                        .setDescription(`✅ | **Пользователь ${message.author} замутил пользователя ${rUser}!**`)
                        .setFooter(bot.user.username, bot.user.avatarURL)
                        .setTimestamp()
                )
                let EmbedMute = new Discord.RichEmbed()
                    .setDescription(`✅ | **Вас замутили на сервере \`${message.guild.name}\`!**`)
                    .setColor(colors)
            ...
            message.channel.send(
                new RichEmbed()
                    .setDescription(`✅ | **Пользователь ${message.author} замутил пользователя ${rUser} по причине \`${reason1}\`!**`)
                    .setColor(colors)
        ...
        if (sym === 's') {
            ...
            if (mutes[rUser.id]) {
                if (!reason) {
                    ...
                    fs.writeFile('./mutes.json', JSON.stringify(mutes), (err) => { if (err) console.error(err); });
                    message.channel.send(
                        new RichEmbed()
                            .setColor(colors)
                            .setFooter(bot.user.username, bot.user.displayAvatarURL)
                            .setTimestamp()
                            .setDescription(`✅ | **Пользователь ${message.author} дополнил мут ${rUser} на ${uts(time, one, two, five)}!**`)
                    )
                    let EmbedMute = new Discord.RichEmbed()
                        .setColor(colors)
                        .setDescription(`Вам дополнили мут на сервере \`${message.guild.name}\`!`)
                ...
                message.channel.send(
                    new RichEmbed()
                        ...
                        .setFooter(bot.user.username, bot.user.displayAvatarURL)
                        .setTimestamp()
                        .setDescription(`✅ | **Пользователь ${message.author} дополнил мут ${rUser} на ${uts(time, one, two, five)} по причине \`${reason}\`!**`)
                )
                let EmbedMute = new Discord.RichEmbed()
                    .setColor(colors)
                    .setDescription(`Вам дополнили мут на сервере \`${message.guild.name}\`!`)
            ...
            if (!reason) {
                ...
                message.channel.send(
                    new RichEmbed()
                        ...
                        .setFooter(bot.user.username, bot.user.displayAvatarURL)
                        .setTimestamp()
                        .setDescription(`✅ | **Пользователь ${message.author} замутил пользователя ${rUser} на ${uts(time, one, two, five)}!**`)
                )
                let EmbedMute = new Discord.RichEmbed()
                    .setDescription(`✅ | **Вас замутили на сервере \`${message.guild.name}\`!**`)
                    .setColor(colors)
            ...
            message.channel.send(
                new RichEmbed()
                    ...
                    .setFooter(bot.user.username, bot.user.displayAvatarURL)
                    .setTimestamp()
                    .setDescription(`✅ | **Пользователь ${message.author} замутил пользователя ${rUser} на ${uts(time, one, two, five)} по причине \`${reason}\`!**`)
            )
            let EmbedMute = new Discord.RichEmbed()
                .setDescription(`✅ | **Вас замутили на сервере \`${message.guild.name}\`!**`)
                .setColor(colors)
